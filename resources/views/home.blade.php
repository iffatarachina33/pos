               ...
               <div class="card-body">
                  <div class="row no-gutters align-items-center">
                     <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800"> ${{ $data['total_amount'] }}</div>
                     </div>
                     <div class="col-auto">
                        <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                     </div>
   ...
   <div class="row"> 
      ...
      <div class="col-xl-8 col-lg-7 col-md-7">
         <div class="card shadow mb-4">
            ...
            <!-- Card Body -->
            <div class="card-body">
               <canvas id="myChart" style="width:100px;max-width:500px;"></canvas>
               <script>
                  var xValues = ["February", "April", "June", "Agust", "October","December"];
                  var yValues = [24, 15, 44, 49, 28,45];
      ...
      <div class="col-xl-4 col-lg-5 col-md-5">
         <div class="card shadow mb-4">
            ...
            <script>
               var xValues = ["January", "France", "Spain", "USA", "Argentina"];
         ...
         <div class="col-lg-6 mb-4">
            ...
            <div class="card shadow mb-4">
               ...
               <div class="card-body">
                  ...
                  <a target="_blank" rel="nofollow" href="https://www.linkedin.com/in/yrnilufa691416/">Browse Illustrations on
                  unDraw →</a>
               </div>
            </div>
            <!-- Approach -->
